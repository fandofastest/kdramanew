package com.koreandrama.newappkorean;
...
import com.koreandrama.newappkorean.adapters.CastCrewAdapter;
import com.koreandrama.newappkorean.adapters.CommentsAdapter;
import com.koreandrama.newappkorean.adapters.EpisodeAdapter;
import com.koreandrama.newappkorean.adapters.DownloadAdapter;
import com.koreandrama.newappkorean.adapters.HomePageAdapter;
import com.koreandrama.newappkorean.adapters.LiveTvHomeAdapter;
import com.koreandrama.newappkorean.adapters.ProgramAdapter;
import com.koreandrama.newappkorean.adapters.ServerApater;
import com.koreandrama.newappkorean.database.DatabaseHelper;
import com.koreandrama.newappkorean.models.CastCrew;
import com.koreandrama.newappkorean.models.GetCommentsModel;
import com.koreandrama.newappkorean.models.CommonModels;
import com.koreandrama.newappkorean.models.EpiModel;
import com.koreandrama.newappkorean.models.PostCommentModel;
import com.koreandrama.newappkorean.models.Program;
import com.koreandrama.newappkorean.models.SubtitleModel;
import com.koreandrama.newappkorean.models.single_details.Cast;
import com.koreandrama.newappkorean.models.single_details.Director;
import com.koreandrama.newappkorean.models.single_details.DownloadLink;
import com.koreandrama.newappkorean.models.single_details.Episode;
import com.koreandrama.newappkorean.models.single_details.Genre;
import com.koreandrama.newappkorean.models.single_details.RelatedMovie;
import com.koreandrama.newappkorean.models.single_details.Season;
import com.koreandrama.newappkorean.models.single_details.SingleDetails;
import com.koreandrama.newappkorean.models.single_details.Subtitle;
import com.koreandrama.newappkorean.models.single_details.Video;
import com.koreandrama.newappkorean.network.RetrofitClient;
import com.koreandrama.newappkorean.network.apis.CommentApi;
import com.koreandrama.newappkorean.network.apis.FavouriteApi;
import com.koreandrama.newappkorean.network.apis.SingleDetailsApi;
import com.koreandrama.newappkorean.network.apis.SubscriptionApi;
import com.koreandrama.newappkorean.network.model.ActiveStatus;
import com.koreandrama.newappkorean.network.model.AdsConfig;
import com.koreandrama.newappkorean.network.model.FavoriteModel;
import com.koreandrama.newappkorean.service.DownloadWorkManager;
import com.koreandrama.newappkorean.utils.PreferenceUtils;
import com.koreandrama.newappkorean.utils.ApiResources;
import com.koreandrama.newappkorean.utils.ads.BannerAds;
import com.koreandrama.newappkorean.utils.Constants;
import com.koreandrama.newappkorean.utils.ads.PopUpAds;
import com.koreandrama.newappkorean.utils.ToastMsg;
import com.koreandrama.newappkorean.utils.Tools;
import com.koreandrama.newappkorean.utils.VolleySingleton;
...
//                    for (int e = 0 ; e>listSubtv.get())
                    ...
                    showDialog(DetailsActivity.this,EpisodeAdapter.listsubsseries);
    ...
    private void getActiveStatus(String userId) {
        ...
        Call<ActiveStatus> call = subscriptionApi.getActiveStatus(com.koreandrama.newappkorean.Config.API_KEY, userId);
                ...
                if (response.code() == 200){
                    ...
                    for (int i = 0; i <singleDetails.getSeason().size(); i++) {
                        ...
                        for (int j = 0; j <singleDetails.getSeason().get(i).getEpisodes().size(); j++) {
                            ...
                            subArray.addAll(singleDetails.getSeason().get(i).getEpisodes().get(j).getSubtitle());
                            if (subArray.size() != 0) {

                                List<SubtitleModel> list = new ArrayList<>();
                                for (int k = 0; k < subArray.size(); k++) {
                                    Subtitle subtitle = subArray.get(k);
...
//
                                subtitleModel.setLang("NO CC");


                                list.add(subArray.size(),subtitleModel);



                                model.setListsubtv(list);
